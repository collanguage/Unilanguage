...
const pages = ["index.html", "semantic-mapper.html", "object-review-method.html", "dictionary.html", "data-foundation.html", "candidate-review.html", "review-decisions.html", "search.html"];
const errors = [];
