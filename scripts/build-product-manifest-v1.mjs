...
const files = [
  ...
  "words/abbreviation.html", "tests/abbreviation-split.test.cjs",
...
const manifest = {
  ...
  version: "1.2.32", dataset_version: dataset.dataset_version, created_at: "2026-09-15",
...
console.log(`Product manifest v1.2.32 written · ${records.length} files`);
