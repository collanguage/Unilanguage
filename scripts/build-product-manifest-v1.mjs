...
const files = [
  ...
  "words/aberrant.html", "tests/aberrant-recalibration.test.cjs", "protocol/protocol.mapping-framework.html",
...
const manifest = {
  ...
  version: "1.2.34", dataset_version: dataset.dataset_version, created_at: "2026-09-15",
...
console.log(`Product manifest v1.2.34 written · ${records.length} files`);
