...
const files = [
  ...
  "words/abdomen.html", "words/universe.html",
...
const manifest = {
  ...
  version: "1.2.4", dataset_version: dataset.dataset_version, created_at: "2026-09-04",
...
console.log(`Product manifest v1.2.4 written · ${records.length} files`);
