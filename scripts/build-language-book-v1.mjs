...
function upgradeUniverse(entry) {
  ...
  entry.references = [
    ...
    { reference_id: "REF-ZDIC-YUZHOU", title: "汉典：宇宙", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%AE%87%E5%AE%99", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-ZHUAN", title: "汉典：轉／转", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E8%BD%AC", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition. Original work cited: 《说文解字》; platform transcription, edition unspecified." },
    ...
    { reference_id: "REF-ZDIC-WO", title: "汉典：斡", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hant/%E6%96%A1", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition. Original work cited: 《广雅》; platform transcription, edition unspecified." },
    ...
    { reference_id: "REF-ZDIC-WHIRLPOOL", title: "汉典：渦／涡", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E6%B6%A1", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-NEST", title: "汉典：窩／窝", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E7%AA%A9", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-SNAIL", title: "汉典：蝸／蜗", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E8%9C%97", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-ZHOU", title: "汉典：周", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%91%A8", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-HE", title: "汉典：合", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%90%88", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-QUAN", title: "汉典：全", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%85%A8", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
...
for (const entry of authoredEntries) {
  ...
  if (index < 0) entries.push(entry);
    ...
    if (!['LB-en-light-001', 'LB-en-at-003', 'LB-en-water-001', 'LB-en-universe-001', 'LB-en-man-001', 'LB-en-sound-001', 'LB-en-sky-001', 'LB-en-language-001', 'LB-en-advance-001'].includes(entry.id)) throw new Error(`Unapproved core override: ${entry.id}`);
    entries[index] = entry;
  }
}
...
const dataset = {
  ...
  editorial_policy: {
    ...
    present_day_vs_diachronic: localized("Present-day Mapping ≠ Diachronic Mapping. Modern standard semantic mapping is separate from the featured candidate; historical-unit comparisons have separate fields, assessments and historical-relation boundaries. Diachronic Stage Mapping Principle: modern forms, historical forms/roots and earlier semantic stages may receive separate Chinese mappings when form, meaning or semantic operation changes materially; not one character per language. Each stage records its own evidence, status and confidence. Mapping pending is valid; Chinese Historical Relation stays Not claimed.", "现代词义映射 ≠ 历时语义映射。现代标准语义映射与特色候选分开；历史单位比较使用独立字段、评分及历史关系边界。历时阶段映射原则：现代形式、历史形式／词根及早期语义阶段，仅在形式、意义或语义操作发生实质变化时分别映射；不机械要求每语言一汉字。每阶段单列证据、状态、置信度；允许 Mapping pending，汉语历史关系仍为 Not claimed。"),
