...
function upgradeUniverse(entry) {
  ...
  entry.references = [
    ...
    { reference_id: "REF-ZDIC-YUZHOU", title: "漢典: 宇宙", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%AE%87%E5%AE%99", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-ZHUAN", title: "漢典: 轉／转", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E8%BD%AC", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition. Original work cited: 《说文解字》; platform transcription, edition unspecified." },
    ...
    { reference_id: "REF-ZDIC-WHIRLPOOL", title: "漢典: 渦／涡", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E6%B6%A1", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-NEST", title: "漢典: 窩／窝", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E7%AA%A9", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-SNAIL", title: "漢典: 蝸／蜗", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E8%9C%97", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-ZHOU", title: "漢典: 周", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%91%A8", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-HE", title: "漢典: 合", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%90%88", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
    { reference_id: "REF-ZDIC-QUAN", title: "漢典: 全", type: "historical/modern dictionary compilation", url: "https://www.zdic.net/hans/%E5%85%A8", path: null, provenance: "Access/aggregation platform: 汉典 (Zdic); modern and attributed historical compilation, not an original dictionary edition." },
