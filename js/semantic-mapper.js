(function () {
  ...
  function renderEntry(entry) {
    ...
    const headerMapping = pilot
      ? `<h2>${escapeHtml(UnilanguageDiachronic.headline(entry))}</h2><p class="standard-translation">Standard Translation: ${escapeHtml(standardGloss)}</p><p>Featured selection is editorial, not an evidence grade. · Historical Relation: Not claimed</p>${UnilanguageDiachronic.renderCards(entry, entry.page + "#research")}`
