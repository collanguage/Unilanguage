...
1. Separate **External Established Evidence** from **Unilanguage Analysis / Proposed Mapping**.
2. Add inline numbered citations (`[1]`, `[2]`) beside factual claims that depend on sources.
3. Provide complete entries under **References**; do not use an unconnected link dump.
4. Prefer primary sources, authoritative historical dictionaries and scholarly publications for consequential claims.
5. Label disputed, tentative and limited evidence, and preserve counterevidence.
