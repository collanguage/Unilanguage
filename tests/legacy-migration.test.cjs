...
test('only four approved entries migrate; every existing research field survives exactly',()=>{
 ...
 const batch=['abbreviate','abbreviation','abdomen','abdominal','universe','human','man','abbey','abash','horizon','horse','media','aback','sound','abridge','aliment','acumen','abound','sky','language','advance','generate','absolute','a-indefinite-article'];
